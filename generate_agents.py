...
CATEGORIES = [
    ...
    },
    {
        ...
        'normal_price': '7.11',
        'normal_aliases': ['透明胶带大卷', '透明胶带', '胶带大卷', '大卷胶带'],
        'normal_kb': {
    ...
    },
    {
        ...
        'normal_price': '5.80',
        'normal_aliases': ['A4白纸', 'A4纸', 'a4纸', '白纸'],
        'normal_kb': {
        ...
        'compare': '超群A4白纸更白、更便宜；A4甘蔗纸更环保、更健康。两者书写打印效果基本一致，差别在颜色与环保属性上。',
        'recommend': '如果您更看重环保与健康，推荐选择B（A4甘蔗纸）；如果更看重白度与价格，可以选择A（超群A4白纸）。',
        'advantage': '环保款A4甘蔗纸以甘蔗纤维为原料、无荧光增白剂，减少林木砍伐、碳排放更低；普通款超群A4白纸为传统木浆纸，漂白生产有一定环境负担。两者书写打印效果基本一致，差别主要在颜色与环保属性上。',
    },
]
